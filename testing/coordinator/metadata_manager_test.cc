...
class MockMetadataManager : public MetadataManager {
 public:
  ...
  MOCK_METHOD(std::vector<vmsdk::cluster_map::NodeInfo>, GetPrimaryNodes, (ValkeyModuleCtx* ctx), (override));
};
...
class EntryOperationTest
 ...
 protected:
  void SetUp() override {
    ...
    // Mock for GetPrimaryNodes - return one fake node to trigger broadcast
    ON_CALL(*test_metadata_manager_, GetPrimaryNodes(testing::_))
        .WillByDefault([]() {
          std::vector<vmsdk::cluster_map::NodeInfo> nodes;
          vmsdk::cluster_map::NodeInfo node;
          node.node_id = "fake_node";
...
TEST_P(EntryOperationTest, TestEntryOperations) {
  ...
  if (test_case.expect_num_broadcasts > 0) {
    EXPECT_CALL(*kMockValkeyModule,
                SendClusterMessage(
                    fake_ctx, testing::StrEq("fake_node"),
...
class MetadataManagerReconciliationTest
 ...
 protected:
  void SetUp() override {
    ...
    // Mock cluster operations with two slot ranges and primary nodes
    ON_CALL(*kMockValkeyModule, Call(testing::_, testing::StrEq("CLUSTER"), testing::StrEq("c"), testing::StrEq("SLOTS")))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xDEADBEEF)));
    ON_CALL(*kMockValkeyModule, CallReplyType(reinterpret_cast<ValkeyModuleCallReply*>(0xDEADBEEF)))
        .WillByDefault(testing::Return(VALKEYMODULE_REPLY_ARRAY));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xDEADBEEF)))
        .WillByDefault(testing::Return(2)); // Two slot ranges
    
    // Mock first slot range array element
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xDEADBEEF), 0))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0001)));
    ON_CALL(*kMockValkeyModule, CallReplyType(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0001)))
        .WillByDefault(testing::Return(VALKEYMODULE_REPLY_ARRAY));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0001)))
        .WillByDefault(testing::Return(3)); // start, end, primary node
    
    // Mock first slot range elements: start=0, end=8191, primary node
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0001), 0))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0002)));
    ON_CALL(*kMockValkeyModule, CallReplyInteger(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0002)))
        .WillByDefault(testing::Return(0)); // start slot
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0001), 1))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0003)));
    ON_CALL(*kMockValkeyModule, CallReplyInteger(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0003)))
        .WillByDefault(testing::Return(8191)); // end slot
    
    // Mock first primary node array
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0001), 2))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0004)));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0004)))
        .WillByDefault(testing::Return(4)); // IP, port, node_id, metadata
    
    // Mock first node elements: IP, port, node_id, metadata
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0004), 0))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0005)));
    ON_CALL(*kMockValkeyModule, CallReplyStringPtr(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0005), testing::_))
        .WillByDefault(testing::DoAll(testing::SetArgPointee<1>(9), testing::Return("127.0.0.1")));
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0004), 1))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0006)));
    ON_CALL(*kMockValkeyModule, CallReplyInteger(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0006)))
        .WillByDefault(testing::Return(6379)); // port
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0004), 2))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0007)));
    ON_CALL(*kMockValkeyModule, CallReplyStringPtr(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0007), testing::_))
        .WillByDefault(testing::DoAll(testing::SetArgPointee<1>(11), testing::Return("primary1_id")));
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0004), 3))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0008)));
    ON_CALL(*kMockValkeyModule, CallReplyType(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0008)))
        .WillByDefault(testing::Return(VALKEYMODULE_REPLY_ARRAY));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0008)))
        .WillByDefault(testing::Return(0)); // empty metadata
    
    // Mock second slot range array element
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xDEADBEEF), 1))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0010)));
    ON_CALL(*kMockValkeyModule, CallReplyType(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0010)))
        .WillByDefault(testing::Return(VALKEYMODULE_REPLY_ARRAY));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0010)))
        .WillByDefault(testing::Return(3)); // start, end, primary node
    
    // Mock second slot range elements: start=8192, end=16383, primary node
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0010), 0))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0011)));
    ON_CALL(*kMockValkeyModule, CallReplyInteger(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0011)))
        .WillByDefault(testing::Return(8192)); // start slot
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0010), 1))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0012)));
    ON_CALL(*kMockValkeyModule, CallReplyInteger(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0012)))
        .WillByDefault(testing::Return(16383)); // end slot
    
    // Mock second primary node array
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0010), 2))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0013)));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0013)))
        .WillByDefault(testing::Return(4)); // IP, port, node_id, metadata
    
    // Mock second node elements: IP, port, node_id, metadata
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0013), 0))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0014)));
    ON_CALL(*kMockValkeyModule, CallReplyStringPtr(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0014), testing::_))
        .WillByDefault(testing::DoAll(testing::SetArgPointee<1>(9), testing::Return("127.0.0.2")));
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0013), 1))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0015)));
    ON_CALL(*kMockValkeyModule, CallReplyInteger(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0015)))
        .WillByDefault(testing::Return(6380)); // port
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0013), 2))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0016)));
    ON_CALL(*kMockValkeyModule, CallReplyStringPtr(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0016), testing::_))
        .WillByDefault(testing::DoAll(testing::SetArgPointee<1>(11), testing::Return("primary2_id")));
    ON_CALL(*kMockValkeyModule, CallReplyArrayElement(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0013), 3))
        .WillByDefault(testing::Return(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0017)));
    ON_CALL(*kMockValkeyModule, CallReplyType(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0017)))
        .WillByDefault(testing::Return(VALKEYMODULE_REPLY_ARRAY));
    ON_CALL(*kMockValkeyModule, CallReplyLength(reinterpret_cast<ValkeyModuleCallReply*>(0xBEEF0017)))
        .WillByDefault(testing::Return(0)); // empty metadata
    
    ON_CALL(*kMockValkeyModule, GetMyClusterID())
        .WillByDefault(testing::Return("fake_node_id"));

    auto test_metadata_manager = std::make_unique<MetadataManager>(&fake_ctx_, *mock_client_pool_);
...
TEST_P(MetadataManagerReconciliationTest, TestReconciliation) {
  ...
  if (test_case.expect_broadcast) {
    // Expect calls to both primary nodes we mocked
    EXPECT_CALL(*kMockValkeyModule,
                SendClusterMessage(
                    &fake_ctx_, testing::StrEq("primary1_id"),
                    coordinator::kMetadataBroadcastClusterMessageReceiverId,
                    testing::_, testing::_))
        .WillOnce(testing::Return(VALKEYMODULE_OK));
    EXPECT_CALL(*kMockValkeyModule,
                SendClusterMessage(
                    &fake_ctx_, testing::StrEq("primary2_id"),
                    coordinator::kMetadataBroadcastClusterMessageReceiverId,
                    testing::_, testing::_))
        .WillOnce(testing::Return(VALKEYMODULE_OK));
  } else {
...
class MetadataManagerTest : public vmsdk::ValkeyTest {
 ...
 protected:
  void SetUp() override {
    ...
    // Default mock for GetPrimaryNodes - return empty (no broadcast)
    ON_CALL(*test_metadata_manager_, GetPrimaryNodes(testing::_))
        .WillByDefault(testing::Return(std::vector<vmsdk::cluster_map::NodeInfo>()));
  }
  void TearDown() override {
    test_metadata_manager_.reset();
    mock_client_pool_.reset();
...
TEST_F(MetadataManagerTest, TestBroadcastMetadata) {
  ...
  // Mock GetPrimaryNodes to return multiple fake primary nodes
  EXPECT_CALL(*test_metadata_manager_, GetPrimaryNodes(fake_ctx))
      .WillOnce([]() {
        std::vector<vmsdk::cluster_map::NodeInfo> nodes;
        vmsdk::cluster_map::NodeInfo node1;
        node1.node_id = "mockId1";
        nodes.push_back(node1);
        
        vmsdk::cluster_map::NodeInfo node2;
        node2.node_id = "mockId2";
        nodes.push_back(node2);
        
        return nodes;
      });

  // Expect SendClusterMessage to be called for each node
  EXPECT_CALL(
      *kMockValkeyModule,
      SendClusterMessage(
          fake_ctx, testing::AnyOf(testing::StrEq("mockId1"), testing::StrEq("mockId2")),
          coordinator::kMetadataBroadcastClusterMessageReceiverId,
